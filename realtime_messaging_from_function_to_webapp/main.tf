...
#resource "azurerm_linux_function_app" "myBroadcastFunction" {
...
resource "azurerm_function_app" "myBroadcastFunction" {
...
#      cd ../BroadcastFunction/ && npm run build && func azure functionapp publish ${azurerm_function_app.myBroadcastFunction.name}
#      az iot hub device-identity create -n ${azurerm_iothub.my-iot-hub.name} -d ${var.deviceName}
#  EOT
#  }
#
#  depends_on = [
#    azurerm_function_app.myBroadcastFunction,
#    azurerm_function_app.myNegotiatorFunction,
#    azurerm_iothub.my-iot-hub
#  ]
#}
